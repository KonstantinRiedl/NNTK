...
- Separately, computes the empirical NTK and NNTK Gram matrices directly from Eq. (14)–(15) and
  sweeps network width and regularizer strength to show the NNTK's flatter eigenvalue spectrum,
